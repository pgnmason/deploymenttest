<?php
/*------------------------------------------------------------------------
# statgeek9.php - Stat Geek Component
# ------------------------------------------------------------------------
# author    Nate Mason
 ...
 */
class JFormFieldstatgeek9 extends JFormFieldList
{
	/**
	...
	protected function getOptions()
	{
		...
		$query->select('#__statgeek_coache.id as id, #__statgeek_coache.firstname as firstname');
