...
class StatgeekViewseason extends JView
{
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('Season :: New') : JText::_('Season :: Edit'), 'season');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('Season :: New :: Administrator') : JText::_('Season :: Edit :: Administrator'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_statgeek/views/season/submitbutton.js");
		JText::script('season not acceptable. Error');
	}
}
?>