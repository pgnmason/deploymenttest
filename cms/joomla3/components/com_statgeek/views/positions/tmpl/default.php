...
<div id="statgeek-positions">
	<?php foreach($this->items as $item): ?>
		...
		$item->linkURL = JRoute::_('index.php?option=com_statgeek&view=position&id='.$item->id.':'.$item->alias);
		?>
		<p><strong>Name</strong>: <a href="<?php echo $item->linkURL; ?>"><?php echo $item->name; ?></a></p>
		<p><strong>Abbreviation</strong>: <?php echo $item->abbreviation; ?></p>
