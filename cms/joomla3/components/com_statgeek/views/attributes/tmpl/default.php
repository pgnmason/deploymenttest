...
<div id="statgeek-attributes">
	<?php foreach($this->items as $item): ?>
		...
		$item->linkURL = JRoute::_('index.php?option=com_statgeek&view=attribute&id='.$item->id.':'.$item->alias);
		?>
		<p><strong>Name</strong>: <a href="<?php echo $item->linkURL; ?>"><?php echo $item->name; ?></a></p>
		<p><strong>Sport</strong>: <?php echo $item->sport; ?></p>
