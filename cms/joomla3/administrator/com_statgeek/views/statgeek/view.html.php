 ...
 * statgeek View
 */
class StatgeekViewstatgeek extends JViewLegacy
{
	/**
	 * Statgeek view display method
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		if($canDo->get('core.create')):
			JToolBarHelper::addNew('statgeek.add', 'JTOOLBAR_NEW');
		endif;
		if($canDo->get('core.edit')):
			JToolBarHelper::editList('statgeek.edit', 'JTOOLBAR_EDIT');
		endif;
		if($canDo->get('core.delete')):
			JToolBarHelper::deleteList('', 'statgeek.delete', 'JTOOLBAR_DELETE');
		endif;
