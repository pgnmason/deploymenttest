 ...
 * Attribute View
 */
class StatgeekViewattribute extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('Attribute :: New') : JText::_('Attribute :: Edit'), 'attribute');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('Attribute :: New :: Administrator') : JText::_('Attribute :: Edit :: Administrator'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_statgeek/views/attribute/submitbutton.js");
		JText::script('attribute not acceptable. Error');
	}
}
?>