 ...
 * stats View
 */
class StatgeekViewstats extends JViewLegacy
{
	/**
	 * Stats view display method
	 * @return void
	 */
...
echo "HERE";
	...
	protected function addToolBar() 
	{
		...
		if($canDo->get('core.create')):
			JToolBarHelper::addNew('stat.add', 'JTOOLBAR_NEW');
		endif;
		if($canDo->get('core.edit')):
			JToolBarHelper::editList('stat.edit', 'JTOOLBAR_EDIT');
		endif;
		if($canDo->get('core.delete')):
			JToolBarHelper::deleteList('', 'stats.delete', 'JTOOLBAR_DELETE');
		endif;
