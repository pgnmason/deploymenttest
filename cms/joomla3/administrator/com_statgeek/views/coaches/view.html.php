 ...
 * coaches View
 */
class StatgeekViewcoaches extends JViewLegacy
{
	/**
	 * Coaches view display method
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		if($canDo->get('core.create')):
			JToolBarHelper::addNew('coache.add', 'JTOOLBAR_NEW');
		endif;
		if($canDo->get('core.edit')):
			JToolBarHelper::editList('coache.edit', 'JTOOLBAR_EDIT');
		endif;
		if($canDo->get('core.delete')):
			JToolBarHelper::deleteList('', 'coaches.delete', 'JTOOLBAR_DELETE');
		endif;
