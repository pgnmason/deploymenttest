 ...
 * Coache Model
 */
class StatgeekModelcoache extends JModelAdmin
{
	/**
	 ...
	 * @since	2.5
	 */
	public function getTable($type = 'coache', $prefix = 'StatgeekTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_statgeek.coache', 'coache', array('control' => 'jform', 'load_data' => $loadData));
	...
	{
		return 'administrator/components/com_statgeek/models/forms/coache.js';
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_statgeek.edit.coache.data', array());
   ...
   public function getFields(&$form,$std=array(),$fieldtype=0){
	    $details = new stdClass();
		$fields = StatGeekHelper::getFields($form,$std,"attribute",0);
		/*if(!empty($std)){
